...
public class DiampotMenu extends GuiBuilder {

    private static Main main;

    public DiampotMenu(Main main) {
        super(27);
        this.main = main;
    }

    public static GuiBuilder createDiampotMenu(Player player, Main main) {
        String worldName = "Diampotcenter";
        ...
        inventory.setItem(13, Center, p -> {
            ...
            String kitCmd = "ffa kits give " + playerName + " " + "diampot";
        ...
        inventory.setItem(22, Coolarena, p -> {
            ...
            String playerName = player.getName();
            String kitCmd = "ffa kits give " + playerName + " " + "diampot";
            String arenaCmd = "ffa coolarenas warp " + playerName + " " + "Diamcoolarena";
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), kitCmd);
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), arenaCmd);
            player.playSound(player.getLocation(), Sound.UI_LOOM_TAKE_RESULT, 1.0f, 1.0f);
            });
