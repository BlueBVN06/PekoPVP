...
public class NethpotMenu extends GuiBuilder {

    private static Main main;

    public NethpotMenu(Main main) {
        super(27);
        this.main = main;
    }

    public static GuiBuilder createNethpotMenu(Player player, Main main) {
        String worldName = "Nethpotcenter";
